...
export default function AddPartnerPage() {
  ...
  const [logo, setLogo] = useState(""); // base64 logo string
  ...
  return (
    <div className="space-y-6 min-h-screen p-6 bg-gray-50 dark:bg-gray-950 transition-colors duration-300">
        ...
        <div className="flex items-center gap-3 pt-2">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Create a new partner affiliation profile
            </p>
          </div>
        </div>
      </div>
      ...
      <form onSubmit={handleSave} className="grid grid-cols-1 lg:grid-cols-12 gap-6">
              ...
              {!logo ? (
                ...
                <div
                  ...
                  className={`border-2 border-dashed rounded-2xl p-8 text-center cursor-pointer transition-colors duration-200 flex flex-col items-center justify-center min-h-[160px] ${
                    isDragActive
                      ? "border-[#16A34A] bg-green-50/30 dark:bg-green-950/10"
        ...
        {/* Right Side: Live Preview Panel (4 Columns on desktop) */}
