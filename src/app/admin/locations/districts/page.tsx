        ...
        <div className="flex flex-wrap items-center gap-3 self-end sm:self-auto">
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="h-10 border border-gray-300 dark:border-slate-800 bg-white dark:bg-slate-900 text-gray-900 dark:text-slate-100 rounded-xl px-3 py-1 text-sm outline-none focus:ring-1 focus:ring-[#16A34A] max-w-[150px] cursor-pointer transition-colors duration-200"
            >
              <option value="All" className="bg-white dark:bg-slate-900 text-gray-900 dark:text-slate-100">All Divisions</option>
              {divisions.map((d) => (
                <option key={d.id} value={d.id} className="bg-white dark:bg-slate-900 text-gray-900 dark:text-slate-100">
                  {d.division_name}
                </option>
              ))}
            </select>
          ...
          {/* Status Filter */}
          <div className="flex items-center gap-2">
            <label className="text-xs font-semibold text-gray-505 dark:text-gray-455 uppercase tracking-wider">Status</label>
            <select
              value={statusFilter}
              onChange={(e) => {
              ...
              className="h-10 border border-gray-300 dark:border-slate-800 bg-white dark:bg-slate-900 text-gray-900 dark:text-slate-100 rounded-xl px-3 py-1 text-sm outline-none focus:ring-1 focus:ring-[#16A34A] cursor-pointer transition-colors duration-200"
            >
                ...
                <TableBody>
                  {districts.map((item, index) => {
                    ...
                    return (
                      ...
                      >
                        {/* SL */}
                        <TableCell className="font-medium text-gray-550 dark:text-gray-405 text-xs pl-6 py-3.5">
                          {sl}
                        </TableCell>
                  ...
                  >
                    <div className="flex items-center justify-between gap-3">
                      <div>
                        ...
                        <span className="font-bold text-gray-900 dark:text-white text-sm">{item.district_name}</span>
                      </div>
